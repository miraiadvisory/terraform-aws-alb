...
| lb\_arn\_suffix | ARN suffix of our load balancer - can be used with CloudWatch. |
| lb\_dns\_name | The DNS name of the load balancer. |
| lb\_id | The ID and ARN of the load balancer we created. |
| lb\_zone\_id | The zone\_id of the load balancer to assist with creating DNS records. |
